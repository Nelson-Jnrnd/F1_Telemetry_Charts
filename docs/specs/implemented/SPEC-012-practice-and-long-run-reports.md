...
| NFR-001 through NFR-004 | Determinism, language, editorial and responsive quality | Practice result fingerprints, policy v1, structured editorial and responsive Workbench | Practice tests, frontend gates, browser check | Implemented and human-accepted |
...
| UX-001 through UX-004 | Story, Evidence, charts, Preview and Export | Workbench Practice branches, three recipes, exact reader renderer | Frontend gates, Practice tests, desktop/mobile browser check | Implemented and human-accepted |
...
- Nelson Jeanrenaud validated SPEC-012 on 2026-08-24. The three acceptance
  packages are accepted as evidence of correct behavior, including their
  intentional readiness block when official Practice classification is
  unavailable. Lifecycle status is Implemented.
...
### AMEND-002: Apply Analysis chart scope to Practice narrative evidence

- **Date:** 2026-08-27
- **Approved by:** Nelson Jeanrenaud in the current Codex task.
- **Change:** In accordance with SPEC-009 AMEND-001, Practice classification,
  integrity, programme unknowns, and essential session context remain
  foundational evidence. Only typed results linked by generated Analysis charts
  are eligible for automatic narrative findings, conclusions, chart placement,
  and Story selection.
- **Reason:** Loading Practice data is not equivalent to choosing every
  available Practice calculation as the subject of the Analysis.
- **Compatibility:** Existing evidence-quality, comparability, non-causality,
  and explicit-exclusion rules remain authoritative. Tests cover chart-scope
  addition/removal and freshness invalidation.
